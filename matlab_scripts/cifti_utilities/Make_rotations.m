...
Lsphere = '/data/cn/data1/scripts/CIFTI_RELATED/Resources/Conte69_atlas-v2.LR.32k_fs_LR.wb/Conte69.L.sphere.32k_fs_LR.surf.gii';
Rsphere = '/data/cn/data1/scripts/CIFTI_RELATED/Resources/Conte69_atlas-v2.LR.32k_fs_LR.wb/Conte69.R.sphere.32k_fs_LR.surf.gii';
cifti_template_file = '/data/cn/data1/scripts/CIFTI_RELATED/Resources/Baddata_bigcluster_LR.dtseries.nii';
output_rotations_file = '/data/nil-bluearc/GMT/Evan/MSC/reliability_correction/Rotated_inds.dtseries.nii';
...
out.data = remapped;
out.dimord = 'pos_time';
ft_write_cifti_mod(output_rotations_file,out);
