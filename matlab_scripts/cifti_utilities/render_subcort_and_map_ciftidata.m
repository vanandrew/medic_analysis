function render_subcort_and_map_ciftidata(filename,structurename_tomap,smoothing_onsurf,aparcfile)
% render_subcort_and_map_ciftidata(filename,structurename_tomap,[smoothing_onsurf],[aparcfile])
%
...
addpath /data/nil-bluearc/GMT/Evan/Scripts/surfice_atlas-master/
addpath /data/nil-bluearc/GMT/Evan/Scripts/spmScripts-master/
...
identmat = '/usr/local/pkg/fsl/etc/flirtsch/ident.mat';
