...
def data_plotter(
    ...
    if colorbar:
        ...
        cbar = f.colorbar(
            colorbar_source_img,
            cax=cbar_ax if cbar_ax is not None else [r[0][0] for r in fig_row],
            location="left",
    ...
    if colorbar2:
        ...
        cbar = f.colorbar(
            ...
            cax=cbar2_ax if cbar2_ax is not None else [r[-1][0] for r in fig_row],
            location="right",
            orientation="vertical",
        )
